...
public class TransactionOutgoingProvider extends Provider<TransactionOutgoing, BaseSearchCriteria> {
    ...
    public List<Transaction> getTransactionsByUser(User user) {
        return this.getEntityManager().createNamedQuery("findTransactionsOutgoingByUser", Transaction.class)
                .setParameter("user", user)
                .getResultList();
    }

    public List<Transaction> getTransactionsByAccount(Account account) {
        return this.getEntityManager().createNamedQuery("findTransactionsOutgoingByAccount", Transaction.class)
