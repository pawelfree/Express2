...
public class TransactionIncomingProvider extends Provider<TransactionIncoming, BaseSearchCriteria> {
    ...
    public List<Transaction> getTransactionsByUser(User user) {
        return this.getEntityManager().createNamedQuery("findTransactionsIncomingByUser", Transaction.class)
                .setParameter("user", user)
                .getResultList();
    }

    public List<Transaction> getTransactionsByAccount(Account account) {
        return this.getEntityManager().createNamedQuery("findTransactionsIncomingByAccount", Transaction.class)
